  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="系统内置" prop="paramType">
        <el-select v-model="queryParams.paramType" placeholder="系统内置" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统内置" align="center" prop="paramType" :formatter="typeFormat" />
...
export default {
  ...
  methods: {
    ...
    typeFormat(row, column) {
      return this.selectDictLabel(this.typeOptions, row.paramType);
    },
    // 取消按钮
    cancel() {
      this.open = false;
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有参数数据项?', "警告", {
          ...
          this.fileDownload(response.data, "系统参数.xlsx");
        }).catch(function() {});
    }
  }
};
